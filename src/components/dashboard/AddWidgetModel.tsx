...
function getUniqueKey(field: FieldInfo, idx: number) {
  // Use both path and type and index to ensure uniqueness
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    {selectedFields.map((fieldPath, idx) => (
                      <Card key={`${fieldPath}__${idx}`} className="p-3 bg-blue-50 dark:bg-blue-950 border-blue-200 dark:border-blue-800">
                        <div className="flex items-center justify-between">
